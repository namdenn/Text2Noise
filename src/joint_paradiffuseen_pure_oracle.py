...
@InferenceAlgoRegistry.register("joint_paradiffuseen_pure_oracle")
class JointParaDiffUSEENPureOracle:
    def __init__(
        self,
    ...
    def run(
        ...
        N_ref = (X - S_ref/self.NF).to(self.device)
        ...
        self.N_ref = N_ref.repeat(self.nbatch, 1, 1, 1)
