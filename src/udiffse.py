...
"""
Reference paper: https://arxiv.org/abs/2309.10450 (Unsupervised speech enhancement with diffusion-based generative models)
"""

from . import InferenceAlgoRegistry
@InferenceAlgoRegistry.register("udiffse")
class UDiffSE:
    def __init__(
        self,
        ...
        device="cuda",
        set_v_to_zero = "no",
        #the followings are not really used for UDiffSE
    ...
    def prior_sampler(self, clean_file = None, vfile_path = None):
        ...
        if self.audio_only : #unconditional generation of an audio of 5s
            ...
            #to make this commented lines work, one needs to unsure a padding for the nb_stft_frame, such that it is a muliple of 64         
