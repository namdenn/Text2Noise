...
@InferenceAlgoRegistry.register("fudiffse_pure_oracle")
class fUDiffSEPureOracle:
    def __init__(
        self,
    ...
    def posterior_sampler(self, startstep=0, divide_s0hat="no"):
        """
    ...
    def run(
        ...
        # ======== pure oracle calculation ======== self.NF
        ...
        # fUDiffSE algorithm
        St = self.posterior_sampler(startstep=startstep,divide_s0hat=divide_s0hat)
