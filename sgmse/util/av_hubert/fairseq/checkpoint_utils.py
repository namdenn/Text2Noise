...
def load_checkpoint_to_cpu(path, arg_overrides=None, load_on_all_ranks=False):
    ...
    if "cfg" in state and state["cfg"] is not None:
        ...
        old_primitive = _utils.is_primitive_type_annotation # is_primitive_type  #https://github.com/microsoft/BioGPT/issues/88#issuecomment-2101820905
        _utils.is_primitive_type_annotation = lambda _: True #is_primitive_type

        state["cfg"] = OmegaConf.create(state["cfg"])

        _utils.is_primitive_type_annotation = old_primitive #is_primitive_type
